...
# Descriptions des indicateurs, partagees par TOUS les vendeurs (yfinance,
# MT5, ...). Extrait de get_stock_stats_indicators_window pour eviter que
# chaque vendeur reecrive la meme prose : l'agent doit lire le meme texte
